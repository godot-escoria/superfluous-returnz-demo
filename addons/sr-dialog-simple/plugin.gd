...
const MANAGER_CLASS = "res://addons/sr-dialog-simple/esc_dialog_simple.gd"
...
func _get_plugin_name():
	return "sr-dialog-simple"


# Unregister ourselves
func _disable_plugin():
	print("Disabling plugin Superfluous Returnz Dialog Simple")
...
func _enable_plugin():
	print("Enabling plugin Superfluous Returnz Dialog Simple")
