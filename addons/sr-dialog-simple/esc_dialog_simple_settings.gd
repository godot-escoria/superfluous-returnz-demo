...
const SETTINGS_ROOT = "escoria/superfluous-dialogs"
...
const WAIT_TIME_AFTER_LINE_MS = "%s/wait_time_after_line_ms" % SETTINGS_ROOT
const WAIT_TIME_AFTER_LINE_MS_DEFAULT_VALUE = 1000
